            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">EMV Desicion Rule</h1>
                    </div>
                    ...
                    <div>
                        <div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card mb-4">
                                    <div class="card-header">
                                        <h6 class="m-0 font-weight-bold text-primary">EMV Desicion Rule Matrix</h6>
                                    </div>
                                    <div class="card-body" id="emv_desicion_matrix">
                ...
                <script src="js/expectedvalue.js"></script>
