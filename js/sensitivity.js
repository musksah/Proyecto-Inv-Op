    ...
    $(function () {
        ...
        $("#customized_alternatives").on('change', function() {
            ...
            if(this.checked) {
                ...
                table_alternatives = '<hr class="sidebar-divider my-0"> <h4 class="text-center text-primary" style="text-decoration:underline; margin-bottom: 25px; margin-top: 20px;"></h4>';
